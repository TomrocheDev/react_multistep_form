...
export default function Plan({ state, dispatch }) {
    const selectedPlan = planButtonsContent.filter((plan) => plan.name === state.currentPlan)[0];
            ...
            <div className="container">
                ...
                <div className="d-flex justify-content-center gap-2 mt-2">
                    <Button
                        ...
                        className={`${
                            state.paymentPeriod === "monthly" ? "mainButton" : "secondaryButton"
                        } btn-sm w-25`}>
                        Monthly
                    </Button>
                    <Button
                        ...
                        className={`${
                            state.paymentPeriod === "yearly" ? "mainButton" : "secondaryButton"
                        } btn-sm w-25`}>
                        Yearly
                    </Button>
                </div>
